...
Setup for Mediapipe-Model-Maker-Text package with setuptools.
"""
...
setuptools.setup(
    name="mediapipe-model-maker-text",
    version=__version__,
    url="https://github.com/google/mediapipe/tree/master/mediapipe/model_maker",
    description=(
        "MediaPipe Model Maker Text package for text tasks with "
        "tensorflow-text dependency"
    ),
    ...
    install_requires=_parse_requirements("requirements_text.txt"),
    ...
    license="Apache 2.0",
    keywords=["mediapipe", "model", "maker", "text"],
)
